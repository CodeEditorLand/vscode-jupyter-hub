...
import {
	createServerConnectSettings,
	getUserInfo,
	startServer,
} from "./jupyterHubApi";
import { IAuthenticator, IJupyterHubConnectionValidator } from "./types";

const TIMEOUT_FOR_SESSION_MANAGER_READY = 10_000;

export class JupyterHubConnectionValidator
					...
					while (true) {
						...
						if (didStartServer == "didStartServer") {
							...
							if (
								...
								throw new Error(
									"Failed to enumeration kernel Specs",
								);
							} else {
